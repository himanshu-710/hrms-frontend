...
export default function EducationSection() {
  ...
  const { data, isLoading, isError } = useQuery({
    ...
    queryFn: () =>
      onboardingApi.getEducation(employeeId as number),
    enabled: !!employeeId,
  });

  
  const educationList: EducationItem[] = Array.isArray(data)
    ? data
    : [];

  const addMutation = useMutation({
    mutationFn: (values: EducationPayload) =>
      onboardingApi.createEducation(values),
  ...
  const deleteMutation = useMutation({
    mutationFn: (id: number) =>
      onboardingApi.deleteEducation(id),
